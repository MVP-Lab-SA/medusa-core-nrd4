...
import { Star, ThumbsUp, Camera, Filter, ChevronDown } from "lucide-react";
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <nav className="text-sm text-gray-500 mb-4">
            <a href={`/products/${handle}`} className="hover:text-gray-900">
              Product
            </a>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm sticky top-4">
              ...
              <div className="border-t pt-4">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-600">With photos only</span>
                </label>
              </div>
              ...
              {/* Write Review CTA */}
              <button className="w-full mt-6 bg-gray-900 text-white py-3 rounded-lg font-medium hover:bg-gray-800 transition-colors">
                Write a Review
              </button>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-white border rounded-lg px-4 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-gray-200"
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{review.variant}</p>
                      </div>
                    </div>
